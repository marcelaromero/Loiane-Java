...
public class Ex6Loiane {
    public static void main(String[] args) {
        ...
        while (!ganhou){
            ...
            linha--; // faço isso porque no Java começamos com 0 e se por exemplo o usuario
            // digitar lina 3 coluna 3 na verdade sera pro programa linha 2 coluna 2
            coluna--;
